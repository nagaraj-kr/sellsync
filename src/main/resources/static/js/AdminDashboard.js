  ...
  fetch("http://localhost:8080/api/requests/all")
    .then(res => res.json())
    .then(data => {
...
function approveRequest(type, id) {
  fetch(`http://localhost:8080/api/requests/approve/${type}/${id}`, {
    method: "POST"
  })
  .then(() => {
...
function rejectRequest(type, id) {
  fetch(`http://localhost:8080/api/requests/reject/${type}/${id}`, {
    method: "DELETE"
  })
  .then(() => {
...
document.addEventListener("DOMContentLoaded", loadRequests);
     ...
     fetch("http://localhost:8080/api/admin/dashboard-data", {
  headers: {
...
function deleteManufacturer(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`http://localhost:8080/api/manufacturer/deactivate/${id}`, {
        method: 'PUT',
        headers: {
...
function activateManufacturer(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`http://localhost:8080/api/manufacturer/activate/${id}`, {
        method: 'PUT',
        headers: {
          "Content-Type": "application/json"
        }
...
function loadManufacturers() {
  ...
  fetch("http://localhost:8080/api/manufacturer/active")
    .then(response => response.json())
    .then(data => {
      data.forEach(m => {
        const row = document.createElement("tr");
...
`;
  ...
  fetch("http://localhost:8080/api/manufacturer/inactive")
    .then(response => response.json())
    .then(data => {
      data.forEach(m => {
        const row = document.createElement("tr");
...
function deleteWholesaler(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`http://localhost:8080/api/wholesaler/deactivate/${id}`, {
        method: 'PUT',
        headers: {
          "Content-Type": "application/json"
        }
...
function editManufacturer(id) {
  fetch(`http://localhost:8080/api/manufacturer/${id}`)
    .then(response => {
      if (!response.ok) {
...
function editWholesaler(id) {
  fetch(`http://localhost:8080/api/wholesaler/${id}`)
    .then(response => {
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
...
function openModal(type, data = null) {
  ...
  let url = `http://localhost:8080/api/${entityType}`;
  let method = "POST";
...
function loadWholesalers() {
  ...
  fetch("http://localhost:8080/api/wholesaler/active")
    .then(res => res.json())
    .then(data => {
      data.forEach(w => {
        const row = document.createElement("tr");
...
`;
  ...
  fetch("http://localhost:8080/api/wholesaler/inactive")
    .then(res => res.json())
    .then(data => {
      data.forEach(w => {
        const row = document.createElement("tr");
...
function activateWholesaler(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`http://localhost:8080/api/wholesaler/activate/${id}`, {
        method: 'PUT',
        headers: {
          "Content-Type": "application/json"
        }
